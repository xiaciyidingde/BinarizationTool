...
- **v1.4.3.0** (2026-03-24): 多语言支持（中文/英文完整翻译）
- **v1.4.2.0** (2026-03-24): 添加设置和关于按钮，完整的配置管理系统
...
- **v1.2.3.0** (2026-03-22): 测试改进（新增 38 个测试，覆盖率提升，Hypothesis 属性测试）
